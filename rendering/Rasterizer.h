...
namespace render
{
    ...
    public:
        ...
        unsigned int
        drawPoints(const RenderConfig &renderConfig, const VertexList &vertices, const IndexList &indices) const;

        // Draws the vertices as lines. Every two indices define the endpoints of a line.
        unsigned int drawLines(const RenderConfig &renderConfig, const VertexList &vertices, const IndexList &indices) const;
        ...
        unsigned int drawLineStrip(const RenderConfig &renderConfig, const VertexList &vertices, const IndexList &indices) const;
        ...
        unsigned int drawTriangles(const RenderConfig &renderConfig, const VertexList &vertices, const IndexList &indices) const;

    private:
        // Draws a line after it was clipped to the Viewport.
        void drawLine(const RenderConfig &renderConfig, const LinePrimitive &line) const;

        // Draws a triangle that was clipped to the viewport.
        void drawTriangle(const RenderConfig &renderConfig, const TrianglePrimitive &t) const;
