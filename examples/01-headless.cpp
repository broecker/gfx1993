...
{
	// Clear the buffers
    renderConfig.framebuffer->clear( glm::vec4(0, 0, 0.2f, 1) );
	...
	try
	{
	    rasterizer->drawTriangles(vertices, indices, renderConfig);
	}
...
int main(int argc, char** argv)
{
    ...
    renderConfig.fragmentShader = std::make_shared<render::InputColourShader>();
